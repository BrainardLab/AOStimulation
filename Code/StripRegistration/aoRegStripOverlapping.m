function [regImage,status]=aoRegStripOverlapping(refImage,desinMovies,sysPara,imagePara)
...
nStrip = fix(imagePara.H/2)-(sysPara.stripSize-2) ;
...
for stripIdx = 1 : nStrip
    ...
    searchStripUpLeftx=1+(stripIdx-1)*2+sysPara.ROIx;
