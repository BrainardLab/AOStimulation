...
function [success, cardInfo] = spcMSetupModeRecStdAverage (cardInfo, chEnableH, chEnableL, memSize, segmentSize, posttrigger, averages)
    
    error = 0;

    % ----- setup the mode -----
    error = error + spcm_dwSetParam_i32 (cardInfo.hDrv, 9500,                 131072);  % 9500 = SPC_CARDMODE, 131072 = SPC_REC_STD_AVERAGE
